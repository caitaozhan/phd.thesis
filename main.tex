...
\thesistitle{Transmitter Localization in Classical and Quantum Sensor Networks} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\emph{Committee:} \\
\href{https://www3.cs.stonybrook.edu/~samir/}{Professor Samir Das} \\ % Supervisor name - remove the \href bracket to remove the link  
\emph{Committee:} \\
\href{https://www3.cs.stonybrook.edu/~cram/}{Professor C.R. Ramakrishnan} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
