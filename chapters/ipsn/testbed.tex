...
\begin{figure}
	\centering
	\subfloat[Indoor lab environment]{\includegraphics[width=0.45\textwidth]{chapters/ipsn/figures/indoor.jpg}}
	\qquad
	\hspace{-0.15in}
	\subfloat[Floor plan]{\includegraphics[width=0.42\textwidth]{chapters/ipsn/figures/floor-plan.png}}
