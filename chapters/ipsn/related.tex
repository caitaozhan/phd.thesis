...
Bayesian methods are a subset of statistics in which probability expresses
a degree of belief in an event. Bayes' theorem provides a way to update the
probability of a hypothesis as more evidence or information becomes available.
It combines prior knowledge with new evidence to form a posterior probablity.
Bayesian methods are used to calculate the parameters for movement time distribution models~\cite{hangzhao2021}
and to predict the distribution and the mean of pointing movement time~\cite{hangzhao2022}.
