...
\begin{figure}
	\centering
	\subfloat{\includegraphics[width=0.5\textwidth]{chapters/ipsn/figures/interpolate.png}}
	\qquad
	\newline
	\subfloat{\includegraphics[width=0.7\textwidth]{chapters/ipsn/figures/ildw.png}}
        \hspace{0.3in}
