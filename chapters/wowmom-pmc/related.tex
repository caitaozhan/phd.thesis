...
Reinforcment learning~\cite{chen2023rgmcomm} has been novelly applied in various network utility optimization problems~\cite{chen2021bringing,chen2023distributional} .
FIAT~\cite{yunming2022} uses machine learning methods to acheive frictionless authentication for IoT traffic.
Graph neural networks have shown to enhance quantum approximate optimization algorithms as a warm-start technique~\cite{zhiding2024}.
