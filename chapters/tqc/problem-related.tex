\section{\bf \iso Problem and Related Work}
...
{\em We assume that events in our setting affect exactly one sensor with uniform probability.}\footnote{\blue{In essence, we assume that sensors are sparsely deployed such that
...
\blue{Finally in \S\ref{sec:extend}, we consider generalizations related to 
