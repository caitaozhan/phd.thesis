...
also enable various important applications~\cite{qsn,qkd,atomic,secure,byzantine}.
%such as quantum sensor networks~\cite{qsn}, quantum key
...
~\cite{tqe22-quantum} sovles the \spp Problem: Given a single $(s,d)$ pair, select a minimum-latency swapping tree under given constraints. 
